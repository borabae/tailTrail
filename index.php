...
<body>
    ...
    <main>
        ...
        <section id="lost">
            ...
            <form id="lostPetForm" action="lostSubmit.php" method="post">
                ...
                <label for="lostColor">Color:</label>
                <input type="text" id="lostColor" name="lostColor" placeholder="What colour is your pet?" required autocomplete="off">
                ...
                <input type="url" id="lostPetImage" name="lostPetImage" placeholder="Enter URL with image of animal" required>
        ...
        <section id="found">
            ...
            <form id="foundPetForm" action="foundSubmit.php" method="post">
                ...
                <select id="foundBreed" name="foundBreed" placeholder="Do you know the animal's breed?" autocomplete="off"></select>
                ...
                <label for="foundPetImage">Image URL:</label>
                <input type="url" id="foundPetImage" name="foundPetImage" placeholder="Enter URL with image of animal" required>

                <fieldset class="radio-container" id="contact-method2">
                    <legend>Contact Method:</legend>
